...
$ns color 1 Green
$ns color 2 Blue
set nf [open outfile2.nam w]
$ns namtrace-all $nf
set tf [open tracefile2.tr w]
$ns trace-all $tf
...
# #Detach udp and null agents (not really necessary)

# $ns at 4.5 "$ns detach-agent $n1 $udp ;$ns detach-agent $n5 $null"